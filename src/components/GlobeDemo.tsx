...
export const GlobeDemo = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-center  relative w-full xl:h-auto lg:h-[550px] md:h-[450px] h-[350px]">
      <div className=" mx-auto w-full relative h-full px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
        ...
        >
          <p className=" max-w-md  mx-auto text-white font-serif text-center mt-6 text-3xl">
